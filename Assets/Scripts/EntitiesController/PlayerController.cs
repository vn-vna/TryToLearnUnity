///
/// <summary>
/// Script is written by Matthew Spencer.
/// === AUTHOR QUOTES:
...
public class PlayerController : MonoBehaviour, IPlayerController
{
  ...
  public int ScroreLooseWhenDie = 20;
  ...
  void Start()
  {
    SpawnerManager.Player = this.gameObject;
  }

  private void Update()
  {
    if (GameStatusController.IsPaused)
    {
      return;
    }
  ...
  private void GatherInput()
  {
    Input = new FrameInput
    {
      ...
      JumpUp = UnityEngine.Input.GetKeyDown(KeyCode.X),
  ...
  public RespawnControl SpawnerManager;
  ...
  {
    _isDied = true;
    Inventory.Score -= ScroreLooseWhenDie;
  }

  private void TryToRespawn()
  {
    SpawnerManager.Respawn();
    _isDied = false;
  }
